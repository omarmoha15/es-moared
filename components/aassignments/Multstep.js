    ...
    return(
        ...
        className={
          ...
          <div className='relative flex flex-col items-center text-teal-600'>
            ...
            >{step.completed ? (
              <span className=' text-white font-bold text-1xl'> &#10003;</span>
          ...
          <div className={`flex-auto border-t-2 transition duration-500 ease-in-out ${step.completed ? "border-gray-600":"border-gray-300"}`}></div>
        </div>
